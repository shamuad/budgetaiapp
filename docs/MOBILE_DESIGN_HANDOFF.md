...
- This branch is stacked on the unmerged mobile-foundation branch. Review and merge order must preserve that dependency; PR #8 still requires explicit product approval.
